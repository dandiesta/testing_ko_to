<div class="list-group">
    ...
    <div class="list-group-item">
        <ul class="nav nav-pills nav-stacked">
            <li @if ($current_page == 'edit_package') class="active" @endif>
                <a href="{{ route('edit_package', ['id' => $app->app_id]) }}"><i class="fa fa-pencil"></i> Edit</a>
            </li>
    ...
    <div class="list-group-item">
        <div class="text-center">
            ...
            <img src="https://chart.googleapis.com/chart?chs=150&cht=qr&chl={{ urlencode(route('package')) }}">
        </div>
    </div>
</div>
